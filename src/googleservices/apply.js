...
const sendReviewMail = async (data) => {
    ...
    let mailOptions = {
        ...
        html: `<h4 style="display: flex; align-items: center;">Hi ${data.firstname}, <br> Welcome to the Shoman Mentorship Progmram where we help you levelup  your Skills</h4>
        ...
        <br><br>
        <h5>Best Regards, <b><span style="color: red;">Shoman</span></b> Team.</h5>
    `,
    }
